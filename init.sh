...
plugins=(git rbenv pyenv rails gem node npm bower gradle grunt brew z docker docker-compose docker-machine osx terminalapp sublimetext extract tmux fzf virtualenv)
