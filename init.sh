...
plugins=(git rbenv pyenv rails gem node npm yarn nvm brew z docker docker-compose osx extract tmux fzf virtualenv zsh-autosuggestions zsh-syntax-highlighting taskwarrior youtube-dl vi-mode jeff bat mediakeys meeting)
