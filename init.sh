...
plugins=(git rbenv rails gem node npm yarn z docker docker-compose osx extract tmux fzf virtualenv zsh-autosuggestions zsh-syntax-highlighting zsh-vi-mode taskwarrior vi-mode jeff bat mediakeys meeting kitty ghostty man android pokemon-colorscripts)
