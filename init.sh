...
plugins=(git rbenv rails gem node npm yarn z docker docker-compose osx extract tmux fzf virtualenv zsh-autosuggestions zsh-syntax-highlighting zsh-vi-mode taskwarrior youtube-dl vi-mode jeff bat mediakeys meeting kitty ghostty man android pokemon-colorscripts)
...
alias vi="vim"
alias v="vim"
alias work="git diff --relative --name-only \$(git branch -rl '*/HEAD' | grep -o '[^/]\+$') | xargs nvim"
