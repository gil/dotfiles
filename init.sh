...
plugins=(git rbenv pyenv rails gem node npm nvm bower gradle grunt brew z docker docker-compose docker-machine osx terminalapp sublimetext extract tmux fzf virtualenv zsh-autosuggestions zsh-syntax-highlighting taskwarrior)
