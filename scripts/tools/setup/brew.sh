...
if hash brew 2>/dev/null; then
    ...
    # General tools
    for package in tmux ack the_silver_searcher ripgrep wget curl figlet youtube-dl ghostscript lame fpp fdupes ncdu mosh clipper reattach-to-user-namespace; do
