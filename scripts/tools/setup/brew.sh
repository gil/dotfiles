...
if hash brew 2>/dev/null; then
    ...
    # General tools
    for package in vim tmux ack the_silver_searcher ripgrep wget curl figlet youtube-dl lame fpp fdupes ncdu mosh clipper reattach-to-user-namespace pipenv socat graphicsmagick ffmpeg weechat aria2; do
