...
alias glog='git log --graph --date=format:"%Y-%m-%d %H:%M" --pretty=format:"%C(auto,yellow)%h%C(auto,blue)%>(17,trunc)%ad %C(auto,green)%<(20,trunc)%ae %C(auto,reset)%s%C(auto,red)% gD% D"'
