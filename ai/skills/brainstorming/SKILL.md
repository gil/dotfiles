...
5. **Write design doc** — save to `docs/tinypowers/specs/YYYY-MM-DD-<topic>-design.md` and commit
...
- Write the validated design (spec) to `docs/tinypowers/specs/YYYY-MM-DD-<topic>-design.md`
